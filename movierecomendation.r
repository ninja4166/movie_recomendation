...
gen_col = which(genre_mat1[1,] == movie_genre2[index,col]) genre_mat1[index+1,gen_col] <- 1
}
}
...
recommendation_model$IBCF_realRatingMatrix$parame 
...
Table_of_Ratings
#most viewed movies visulization
...
normalized_ratings <- normalize(movie_ratings)sum(rowMeans(normalized_ratings) > 0.00001)
...
#pridicting top rocomendation top 10 
